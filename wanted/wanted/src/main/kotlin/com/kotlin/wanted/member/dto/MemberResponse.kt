...
data class MemberIssueAccessToken(val result: Boolean,val accessToken: String, val message: String)
data class MemberDiscardRefreshTokenResponse(val result: Boolean,val email : String, val message: String)